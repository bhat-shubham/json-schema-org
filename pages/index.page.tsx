      ...
      <div className='flex flex-col items-center w-full'>
        ...
        <section className='max-w-[1400px] mt-12 lg:mt-[80px]'>
          ...
          <div className='w-5/6 lg:w-3/5 grid grid-cols-1 md:grid-cols-2 gap-6   my-[85px] mx-auto '>
            <div className='card w-full dark:shadow-slate-700 shadow-3xl'>
            ...
            <div className='card w-full dark:shadow-slate-700 shadow-3xl'>
              <div className='card-body'>
                <h2 className='card-title mb-3'>Exchange Data Seamlessly</h2>
                <p>
            ...
            <div className='card w-full dark:shadow-slate-700 shadow-3xl'>
              <div className='card-body'>
                <h2 className='card-title mb-3'>Document your data</h2>
                <p>
            ...
            <div className='card w-full dark:shadow-slate-700 shadow-3xl'>
              <div className='card-body'>
                <h2 className='card-title mb-3'>Vibrant tooling ecosystem</h2>
                <p>
